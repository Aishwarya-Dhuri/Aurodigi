...
@Component({
  selector: 'app-querybuildercheckbox',
  templateUrl: './querybuildercheckbox.component.html',
  styleUrls: ['./querybuildercheckbox.component.scss']
})
export class QuerybuildercheckboxComponent implements OnInit {
