...
import { ContactInfo, CorporateOnboarding, TransactionDetails, CorporateSecurityDetails, paymentsRow } from './@models/corporate-onboarding.model';
...
export class CorporateOnboardingComponent implements OnInit {
  ...
  formData: CorporateOnboarding = new CorporateOnboarding();
  ...
  showPaymentsAddModal = false;





  ipMappingColDefs: string = 'setup/security/corporateOnboarding/private/getIpMappingColDef';
  ipMappingReviewColDefs: string = 'setup/security/corporateOnboarding/private/getIpMappingReviewColDef';
  ipMappedGridOptions = {
  ...
  stepperDetails: Stepper = {
    masterName: 'Corporate Onboarding',
    currentStep: 1,
  ...
  getViewData(): void {
    ...
    if (this.mode == 'EDIT' || this.mode == 'VIEW') {
      ...
      this.httpService
        .httpPost('setup/security/corporateOnboarding/private/view', data)
        .subscribe((formData: CorporateOnboarding) => {
  ...
  paymentNormalChargeCategory = [
    ...
    { id:5, displayName: "PROCESSINGEOD" }
  ...
  paymentPromotionalChargeCategory = [
    ...
    { id: 2, displayName: "promotional abc" },
  ...
  onshowshowProcessingCentreId(val: any) {
    this.formData.processingCentreId = val.businessCode;
  }
