...
import { BankRole, RoleRights, RoleWidget } from './@models/role.model';

@Component({
  selector: 'app-bank-role-form',
  templateUrl: './bank-role.component.html',
  styleUrls: ['./bank-role.component.scss'],
})
export class BankRoleComponentForm implements OnInit {
  @Input('viewOnAnotherComponent') viewOnAnotherComponent: boolean = false;
  formData: BankRole = new BankRole();
  mode: string = '';
