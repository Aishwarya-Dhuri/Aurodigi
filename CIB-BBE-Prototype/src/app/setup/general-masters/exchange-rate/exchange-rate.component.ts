...
export class ExchangeRateComponent implements OnInit {
  ...
  formData: ExchangeRate = new ExchangeRate();
  mode: string;
  subModuleNameList = []
  isViewPassword: boolean = false;

  stepperDetails: Stepper = {
    masterName: 'Exchange Rate',
    currentStep: 1,
  ...
  getViewData(): void {
    ...
    if (this.mode == 'EDIT' || this.mode == 'VIEW') {
      ...
      this.httpService
        .httpPost('setup/generalMasters/exchangeRate/private/view', data)
        .subscribe((formData: ExchangeRate) => {
