...
} from './@model/virtual-account-issuance-hierarchy.model';

@Component({
  selector: 'app-virtual-account-issuance-hierarchy',
  templateUrl: './virtual-account-issuance-hierarchy.component.html',
  styleUrls: ['./virtual-account-issuance-hierarchy.component.scss'],
})
export class VirtualAccountIssuanceHierarchyComponent implements OnInit {
    ...
    if (this.mode == 'EDIT' || this.mode == 'VIEW') {
      ...
      this.httpService
        ...
        .subscribe((formData: VirtualAccountIssuanceHierarchy) => {
          ...
          if (formData.entityType == 'Hierarchy') {
  ...
  onChangeEntityType(event: any) {
    if (this.formData.entityType == 'Hierarchy') {
  ...
  validateForm(stepNo: number) {
    if (stepNo == 1) {
      ...
      if (this.formData.entityType == 'Linear') {
    ...
    if (stepNo == 2) {
      if (this.formData.entityType == 'Hierarchy') {
        ...
        const mainAccount = {
          ...
          entityName: this.formData.entityType,
          actions,
        };
