...
import {
  ...
  StructureComponent,
  StructurePreview,
} from './@models/corporate-va-structure-pobo.model';

@Component({
  selector: 'app-corporate-va-structure-pobo',
  templateUrl: './corporate-va-structure-pobo.component.html',
  styleUrls: ['./corporate-va-structure-pobo.component.scss'],
})
export class CorporateVaStructurePoboComponent implements OnInit {
  mode: string;
    ...
    if (this.mode == 'EDIT' || this.mode == 'VIEW') {
      ...
      this.httpService
        ...
        .subscribe((formData: CorporateVAStructure) => {
          ...
          if (this.mode == 'VIEW') this.stepperDetails.currentStep = 3;
        });
    }
  }
  ...
  getAccountNoList(): void {
    /* const data = {"filters": [{ "name": "corpId", "value": this.formData.corporateId, "type": "String"}]}; */
