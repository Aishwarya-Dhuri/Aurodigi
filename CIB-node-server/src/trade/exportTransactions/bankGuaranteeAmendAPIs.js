...
router.post(
  '/dummyServer/json/trade/exportTransactions/bankGuaranteeAmend/private/getRepairList',
  (req, res) => {
...
router.post(
  '/dummyServer/json/trade/exportTransactions/bankGuaranteeAmend/private/getRecentList',
  (req, res) => {
...
router.post(
  '/dummyServer/json/trade/exportTransactions/bankGuaranteeAmend/private/searchDataList',
  (req, res) => {
    let pendingList = getAllList(
      './dummyServer/json/trade/exportTransactions/bankGuarantee/data.xlsx',
      req.body ? req.body : defaultReqModel,
      req.session.userDetails,
    );
