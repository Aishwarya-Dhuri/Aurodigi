...
router.post(
  '/dummyServer/json/trade/exportTransactions/bankGuarantee/private/getAuthorizedList',
  (req, res) => {
...
router.post(
  '/dummyServer/json/trade/exportTransactions/bankGuarantee/private/getRepairList',
  (req, res) => {
...
router.post(
  '/dummyServer/json/trade/exportTransactions/bankGuarantee/private/getRecentList',
  (req, res) => {
