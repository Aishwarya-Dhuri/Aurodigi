...
router.post(
  '/dummyServer/json/trade/importTransactions/shippingGuarantee/private/getAuthorizedList',
  (req, res) => {
...
router.post(
  '/dummyServer/json/trade/importTransactions/shippingGuarantee/private/getRepairList',
  (req, res) => {
...
router.post(
  '/dummyServer/json/trade/importTransactions/shippingGuarantee/private/getRecentList',
  (req, res) => {
...
//Get LC Number
router.post(
  '/dummyServer/json/trade/importTransactions/shippingGuarantee/private/getLCNumberList',
  (req, res) => {
