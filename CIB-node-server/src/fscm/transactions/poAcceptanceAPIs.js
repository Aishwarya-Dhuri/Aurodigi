...
const getData = () => {
  var dataXlFile =
    './dummyServer/json/fscm/transactions/poAcceptance/authorizedInvoiceData.xlsx';
  var dataWorkbook = XLSX.readFile(dataXlFile);

  return XLSX.utils.sheet_to_json(dataWorkbook.Sheets['Sheet1']);
};

const getNearDueData = () => {
  var dataXlFile =
    './dummyServer/json/fscm/transactions/poAcceptance/dueInvoiceData.xlsx';
  var dataWorkbook = XLSX.readFile(dataXlFile);
...
router.post(
  '/dummyServer/json/fscm/transactions/poAcceptance/private/getAuthorizedInvoice',
  (req, res) => {
    const dataXlFile =
      './dummyServer/json/fscm/transactions/poAcceptance/authorizedInvoiceData.xlsx';
...
router.post(
  '/dummyServer/json/fscm/transactions/poAcceptance/private/getAcceptedInvoices',
  (req, res) => {
    var dataXlFile = './dummyServer/json/fscm/transactions/poAcceptance/data.xlsx';
    var dataWorkbook = XLSX.readFile(dataXlFile);
...
router.post(
  '/dummyServer/json/fscm/transactions/poAcceptance/private/getRecentInvoices',
  (req, res) => {
    const data = getData()
      .filter((d) => {
        return true;
...
router.post(
  '/dummyServer/json/fscm/transactions/poAcceptance/private/getNearDueInvoices',
  (req, res) => {
    const data = getNearDueData()
      .filter((d) => {
        return true;
      })
      .map((d) => {
...
router.post(
  '/dummyServer/json/fscm/transactions/poAcceptance/private/getSearchedInvoices',
  (req, res) => {
    const data = getData()
      .filter((d) => {
        return true;
...
router.post(
  '/dummyServer/json/fscm/transactions/poAcceptance/private/acceptInvoices',
  (req, res) => {
    const dataXlFile = './dummyServer/json/fscm/transactions/poAcceptance/data.xlsx';
    const invoiceXlFile =
      './dummyServer/json/fscm/transactions/poAcceptance/authorizedInvoiceData.xlsx';
...
router.post(
  '/dummyServer/json/fscm/transactions/poAcceptance/private/rejectInvoices',
  (req, res) => {
    const dataXlFile = './dummyServer/json/fscm/transactions/poAcceptance/data.xlsx';
    const invoiceXlFile =
      './dummyServer/json/fscm/transactions/poAcceptance/authorizedInvoiceData.xlsx';
...
router.post(
  '/dummyServer/json/fscm/transactions/poAcceptance/private/authorize',
  (req, res) => {
    ...
    const data = getViewData(
      './dummyServer/json/fscm/transactions/poAcceptance/data.xlsx',
      filters,
    );
