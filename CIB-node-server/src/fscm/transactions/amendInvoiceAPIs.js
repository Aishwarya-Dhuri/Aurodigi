...
router.post(
  '/dummyServer/json/fscm/transactions/amendInvoice/private/getAcceptedAuthorizedInvoice',
  (req, res) => {
...
router.post(
  '/dummyServer/json/fscm/transactions/amendInvoice/private/getAmendInvoiceList',
  (req, res) => {
