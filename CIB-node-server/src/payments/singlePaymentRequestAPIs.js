...
router.post(
  '/dummyServer/json/payments/transactions/singlePaymentRequest/private/getAuthorizedList',
  (req, res) => {
    const response = getAuthorizedListRecords(
      '.' + req.url.substring(0, req.url.indexOf('private')) + 'data.xlsx',
      req.body,
...
router.post(
  '/dummyServer/json/payments/transactions/singlePaymentRequest/private/getAllTransactionEnquiryList',
  (req, res) => {
