...
router.post(
  '/dummyServer/json/payments/transactions/oatTemplateManagement/private/create',
  (req, res) => {
    req.body.templateName = req.body.templateDisplayName;
    const dataXlFile =
      './dummyServer/json/payments/transactions/ownAccountTransfer/templateData.xlsx';
...
router.post(
  '/dummyServer/json/payments/transactions/oatTemplateManagement/private/getAllCount',
  (req, res) => {
    ...
    response.dataList.forEach((list) => {
      ...
      let dataFileUrl = './dummyServer/json/payments/transactions/ownAccountTransfer';
...
router.post(
  '/dummyServer/json/payments/transactions/oatTemplateManagement/private/getPendingList',
  (req, res) => {
    const dataXlFile =
      './dummyServer/json/payments/transactions/ownAccountTransfer/templateData.xlsx';
...
router.post(
  '/dummyServer/json/payments/transactions/oatTemplateManagement/private/getAuthorizedList',
  (req, res) => {
    const dataXlFile =
      './dummyServer/json/payments/transactions/ownAccountTransfer/templateData.xlsx';
...
router.post(
  '/dummyServer/json/payments/transactions/oatTemplateManagement/private/getRejectedList',
  (req, res) => {
    const dataXlFile =
      './dummyServer/json/payments/transactions/ownAccountTransfer/templateData.xlsx';
...
router.post(
  '/dummyServer/json/payments/transactions/oatTemplateManagement/private/getDisabledList',
  (req, res) => {
    const dataXlFile =
      './dummyServer/json/payments/transactions/ownAccountTransfer/templateData.xlsx';
...
router.post(
  '/dummyServer/json/payments/transactions/oatTemplateManagement/private/view',
  (req, res) => {
    let filters = [];
...
router.post(
  '/dummyServer/json/payments/transactions/oatTemplateManagement/private/update',
  (req, res) => {
    const dataXlFile =
      './dummyServer/json/payments/transactions/ownAccountTransfer/templateData.xlsx';
...
router.post(
  '/dummyServer/json/payments/transactions/oatTemplateManagement/private/delete',
  (req, res) => {
    const dataXlFile =
      './dummyServer/json/payments/transactions/ownAccountTransfer/templateData.xlsx';
...
router.post(
  '/dummyServer/json/payments/transactions/oatTemplateManagement/private/authorize',
  (req, res) => {
    const dataXlFile =
      './dummyServer/json/payments/transactions/ownAccountTransfer/templateData.xlsx';
...
router.post(
  '/dummyServer/json/payments/transactions/oatTemplateManagement/private/reject',
  (req, res) => {
    let dataXlFile =
      './dummyServer/json/payments/transactions/ownAccountTransfer/templateData.xlsx';
...
router.post(
  '/dummyServer/json/payments/transactions/oatTemplateManagement/private/disable',
  (req, res) => {
    let dataXlFile =
      './dummyServer/json/payments/transactions/ownAccountTransfer/templateData.xlsx';
    let existingWb = XLSX.readFile(dataXlFile);
