...
router.post(
  '/dummyServer/json/payments/billPayments/billerRegistration/private/getMultipleConsumerBills',
  (req, res) => {
...
router.post(
  '/dummyServer/json/payments/billPayments/billerRegistration/private/getBillerConsumerBills',
  (req, res) => {
...
router.post(
  '/dummyServer/json/payments/billPayments/billerRegistration/private/getExistingConsumers',
  (req, res) => {
...
router.post(
  '/dummyServer/json/payments/billPayments/billerRegistration/private/getBillerConsumers',
  (req, res) => {
    const dataFilePath = '.' + req.url.substring(0, req.url.indexOf('private')) + 'data.xlsx';
...
router.post(
  '/dummyServer/json/payments/billPayments/billerRegistration/private/getBillerUnregisteredConsumer',
  (req, res) => {
    let response = { data: [] };
...
router.post(
  '/dummyServer/json/payments/billPayments/billerRegistration/private/getSMEBillerUnregisteredConsumer',
  (req, res) => {
    let response = { data: [] };
