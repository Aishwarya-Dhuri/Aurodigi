...
const getMenus = (req) => {
  ...
  let userData = getViewData('./dummyServer/json/setup/security/bankUser/data.xlsx', [
  ...
  // reading Role data
  let roleWorkbook = XLSX.readFile('./dummyServer/json/setup/security/bankRole/data.xlsx');
