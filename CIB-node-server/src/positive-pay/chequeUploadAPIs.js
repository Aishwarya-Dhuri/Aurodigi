...
router.post(
    '/dummyServer/json/positivePay/transactions/chequeUpload/private/create',
    ...
    (req, res) => {
        ...
        const dataXlFile = './dummyServer/json/positivePay/transactions/chequeUpload/data.xlsx';

        if (req.body.draftId) {
            deleteRecordInExcel(
                './dummyServer/json/positivePay/transactions/chequeUpload/draftData.xlsx',
                req.body.draftId,
            );
...
router.post(
    '/dummyServer/json/positivePay/transactions/chequeUpload/private/view',
    (req, res) => {
        const dataXlFile = './dummyServer/json/positivePay/transactions/chequeUpload/data.xlsx';
...
router.post(
    '/dummyServer/json/positivePay/transactions/chequeUpload/private/viewTransaction',
    (req, res) => {
        const dataXlFile = './dummyServer/json/positivePay/transactions/chequeUpload/data.xlsx';
...
router.post(
    '/dummyServer/json/positivePay/transactions/chequeUpload/private/getActiveList',
    (req, res) => {
...
router.post(
    '/dummyServer/json/positivePay/transactions/chequeUpload/private/getPendingList',
    (req, res) => {
...
router.post(
    '/dummyServer/json/positivePay/transactions/chequeUpload/private/getAuthorizedList',
    (req, res) => {
...
router.post(
    '/dummyServer/json/positivePay/transactions/chequeUpload/private/getRejectedList',
    (req, res) => {
