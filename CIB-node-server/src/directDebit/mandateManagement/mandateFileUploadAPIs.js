...
router.post(
  '/dummyServer/json/directDebit/mandateManagement/mandateFileUpload/private/getActiveList',
  (req, res) => {
    res.json(
      updateActions(
...
router.post(
  '/dummyServer/json/directDebit/mandateManagement/mandateFileUpload/private/getPendingList',
  (req, res) => {
    res.json(
      updateActions(
...
router.post(
  '/dummyServer/json/directDebit/mandateManagement/mandateFileUpload/private/getAuthorizedList',
  (req, res) => {
    res.json(
      updateActions(
...
router.post(
  '/dummyServer/json/directDebit/mandateManagement/mandateFileUpload/private/getRejectedList',
  (req, res) => {
    res.json(
      updateActions(
...
router.post(
  '/dummyServer/json/directDebit/mandateManagement/mandateFileUpload/private/getDisabledList',
  (req, res) => {
    res.json(
      updateActions(
...
router.post(
  '/dummyServer/json/directDebit/mandateManagement/mandateFileUpload/private/getAllList',
  (req, res) => {
    res.json(
      updateActions(
        getAllListRecords(
