...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    ...
    cb(null, 'dummyServer/uploadedFiles/corporateBranchUpload');
  },
...
router.post(
  '/dummyServer/json/setup/generalMasters/corporateBranchUpload/private/create',
  multer({ storage: storage }).single('corporateBranchFile'),
  (req, res) => {
    const file = req.file;
    ...
    req.body.noOfBranches = xlData.length;
    ...
    const dataXlFile = './dummyServer/json/setup/generalMasters/corporateBranchUpload/data.xlsx';
...
router.post(
  '/dummyServer/json/setup/generalMasters/corporateBranchUpload/private/view',
  (req, res) => {
    const dataXlFile = './dummyServer/json/setup/generalMasters/corporateBranchUpload/data.xlsx';
    ...
    viewData['branches'] = xlData.map((record) => {
      const actions = [
        {
          index: 0,
          paramList: 'id',
          methodName: 'onViewBranch',
          type: 'ICON',
          displayName: 'View',
          icon: 'fa-eye',
        },
...
router.post(
  '/dummyServer/json/setup/generalMasters/corporateBranchUpload/private/viewBranch',
  (req, res) => {
    const dataXlFile = './dummyServer/json/setup/generalMasters/corporateBranchUpload/data.xlsx';
    ...
    const branchFilters = [
      {
        name: 'id',
        value: req.body.dataMap.branchId,
      },
    ];

    const branchData = getViewData(viewData.filePath, branchFilters);

    res.json({ ...branchData, responseStatus: { message: '', status: '0' } });
  },
);

router.post(
  '/dummyServer/json/setup/generalMasters/corporateBranchUpload/private/getActiveList',
  (req, res) => {
...
router.post(
  '/dummyServer/json/setup/generalMasters/corporateBranchUpload/private/getPendingList',
  (req, res) => {
...
router.post(
  '/dummyServer/json/setup/generalMasters/corporateBranchUpload/private/getAuthorizedList',
  (req, res) => {
...
router.post(
  '/dummyServer/json/setup/generalMasters/corporateBranchUpload/private/getRejectedList',
  (req, res) => {
